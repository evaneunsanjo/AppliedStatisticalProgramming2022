...
PlayGame.underhood <- function(choice){ 
...
validate_door <-function(choice){
  if(! is.numeric(choice) | choice %i!n% c(1:3)){
   stop("Please insert an integer to play.")
  }
  return(choice)
}


doorchoice <- new_door(1)
validate_door(doorchoice)
